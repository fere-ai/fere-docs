...
We provide support on our Discord server. You can open a ticket on `#support-ticket` channel and
...
You can report bugs on our Discord server. We have a channel `#bug-reports` where
you can report. Make sure to provide us a detailed description, how to reproduce it,
or any screenshots/videos for our team to evaluate.